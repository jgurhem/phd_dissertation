...
Moreover, this approach can be used to avoid the use of global operations on all the computing resources allocated to the application like reductions, broadcast or gather by only allowing such operations in parallel and distributed tasks.
Therefore, these very costly operations are only executed on a subset of the allocated resources.
