...
We installed and performed experiments on two post-petascale computers, PangeII at Total and Jean Zay at IDRIS although we do not have results on Jean Zay and were not able to use the full supercomputer.
Therefore, we were able to observe the capabilities and performances as well as the shortcomings and limitations of the task based programming models on post-petascale supercomputers.
